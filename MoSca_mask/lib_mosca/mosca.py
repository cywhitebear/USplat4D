...
class MoSca(nn.Module):
    ...
    def load_from_ckpt(
        ...
        # Extract spatial_unit from checkpoint to avoid auto-calculation failure
        # when dynamic curves are sparse (e.g., vrig-broom with only 32 dynamic tracks)
        # spatial_unit = float(ckpt.get("spatial_unit", 0.02)) # MY DEBUG
        spatial_unit = None
        ...
        scf = cls(
            ...
            spatial_unit_hard_set=spatial_unit, # MY DEBUG
        )
